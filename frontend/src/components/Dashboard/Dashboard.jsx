...
import { Tractor, TrendingUp, TrendingDown, AlertTriangle, Plus } from 'lucide-react';
                ...
                <div className="pad">
                    ...
                    <div className="g3">
                        <div className="card gold">
                            <span className="ci"><Tractor size={22} /></span>
                        ...
                        <div className="card red">
                            ...
                            <div className="cs">Suma de todas las maquinas</div>
                        </div>
                    </div>
