...
function DetalleMaquina({ maquina, onVolver, onEditar, onActualizar }) {
    ...
    const TABS = [
        ...
        <><Settings size={14} style={{marginRight:'5px',verticalAlign:'middle'}} />Registro Trabajo</>,
            ...
            <div className="content"><div className="pad">
                ...
                <div className="dh">
                    ...
                    <div className="dhb">
                        ...
                        <span className="b comp" style={{display:'inline-flex',alignItems:'center',gap:'4px'}}><Clock size={12} /> {(maq.horometroActual || 0).toLocaleString('es-CO')} hrs</span>
                    </div>
                </div>
                ...
                {tab === 0 && (
                    <>
                        <div className="g4">
                            <div className="card green"><span className="ci"><TrendingUp size={22} /></span><div className="cl">Ingresos</div><div className="cv">{fmt(totalIngresos)}</div><div className="cs">total generado</div></div>
                            <div className="card red"><span className="ci"><TrendingDown size={22} /></span><div className="cl">Gastos</div><div className="cv">{fmt(totalGastos)}</div><div className="cs">total gastado</div></div>
                            ...
                            <div className="card blue"><span className="ci"><Clock size={22} /></span><div className="cl">Horas</div><div className="cv xl" style={{ color: '#2980b9' }}>{(maq.horometroActual || 0).toLocaleString('es-CO')}</div><div className="cs">horómetro actual</div></div>
                        </div>
                        <div className="g2">
                            <div className="tbl">
                ...
                {tab === 2 && (
                    <div className="tbl">
                        <div className="th"><strong style={{display:'flex',alignItems:'center',gap:'5px'}}><TrendingUp size={14} /> Ingresos — {maq.nombre}</strong></div>
