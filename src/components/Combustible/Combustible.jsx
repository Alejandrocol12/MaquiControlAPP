    ...
    return (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div className="topbar">
                ...
                <button className="bp" onClick={() => setMostrarForm(!mostrarForm)}>➕ Registrar Carga</button>
            </div>
            ...
            <div className="content"><div className="pad">
                ...
                {/* CARDS */}
                <div className="g3">
                    <div className="card orange"><span className="ci">⛽</span><div className="cl">Gasto total</div><div className="cv">{fmt(totalGasto)}</div><div className="cs">acumulado</div></div>
                    <div className="card blue"><span className="ci">🪣</span><div className="cl">Galones total</div><div className="cv">{totalGalones.toLocaleString('es-CO')}</div><div className="cs">acumulados</div></div>
                    <div className="card gold"><span className="ci">📋</span><div className="cl">Cargas total</div><div className="cv">{totalCargas}</div><div className="cs">registros</div></div>
                </div>
                    ...
                    <div className="fc">
                        ...
                        {form.galones && form.precioPorGalon && (
                            <div className="rbox">
                                ...
                                <div style={{ textAlign: 'right' }}><div style={{ color: '#6b7a8d', fontSize: '11px' }}>Se agrega a</div><div style={{ color: '#e74c3c', fontSize: '12px', fontWeight: '700' }}>💸 Gastos</div></div>
                            </div>
                        )}
                        <div style={{ display: 'flex', gap: '10px' }}>
                            <button className="bp" style={{ background: '#e67e22' }} onClick={registrar}>⛽ Registrar Carga</button>
                ...
                <div className="tbl">
                    ...
                    {registros.map(r => (
                        <div className="tr" key={r.id}>
                            ...
                            <span><button className="icon-btn" onClick={() => eliminar(r.id)}>🗑️</button></span>
                        </div>
                    ))}
                </div>
